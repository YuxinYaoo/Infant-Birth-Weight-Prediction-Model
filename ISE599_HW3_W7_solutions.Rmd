---
title: "HW3: Regularization and Cross Validation"
author: "ISE 599 Health Analytics      |||      Dr. Abigail Horn"
date: "Assigned Week 5: 2/09/2024     ||     Due Week 8: 2/28/2024"
output: 
  pdf_document
editor_options: 
...
Due: 2PM PST **Thursday February 29, 2024**
...
- Create the most reliable and most accurate prediction model using regularization methods
- Perform model selection (including parameter estimation) and evaluation using cross validation
...
In this homework, you will build predictive models of a baby's birthweight from variables measured on the fetus before birth, on the mother and her pregnancy, and on the father and family characteristics. 
